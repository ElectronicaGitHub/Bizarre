// Доброго времени суток:) Работу делал порядка 4 часов. 
// Знаю свои проблемы. Насчёт разметки понимаю что можно
// было сделать лучше но учитывая сжатые сроки вышло как то так.
// Насчёт .css , думаю лучше было бы сделать .addClass-ами 
// animate наверное лучше было бы сделать через css транзишены
// Насчёт написанного выше - показалось разумнее после того,
// как уже сделал почти всю работу...
// Делал на chrome, насчёт кроссбраузерности подумал, что выполняя
// задание можно не уделять внимание, но это разумеется не проблема:)
// Прошу дать обратную связь при любом исходе, спасибо.
